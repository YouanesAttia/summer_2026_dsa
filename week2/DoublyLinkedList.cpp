...
int main()
{
    ...
    std::cout << "\nTesting insert_at:\n";
    list.insert_at(2, 15); // 1 5 15 10 20 30
    list.print();

    std::cout << "\nTesting find:\n";
    auto p = list.find(20);
    if (p)
        std::cout << "Found: " << p->data << '\n';
    else
        std::cout << "Not found\n";

    std::cout << "\nTesting delete_at:\n";
    list.delete_at(2); // remove 15
    list.print();

    std::cout << "\nTesting pop_front:\n";
    std::cout << "Removed: " << list.pop_front() << '\n';
    list.print();

    std::cout << "\nTesting pop_back:\n";
    std::cout << "Removed: " << list.pop_back() << '\n';
    list.print();

    std::cout << "\nTesting single element cases:\n";
    list.push_back(100);
    list.print();
